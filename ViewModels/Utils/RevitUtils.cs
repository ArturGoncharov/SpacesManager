...
public static class RevitUtils
{
    ...
    {
        List<DesignOption> linkDesignOptions = new FilteredElementCollector(doc).OfClass(typeof(DesignOption)).Cast<DesignOption>().ToList();
        string designOptionName = null;
        foreach (DesignOption designOption in linkDesignOptions)
        {
